...
<body id="wrapper" style="margin-top: 10px;">
    <div class="row invtblerow565">
        <div class="relative">
            <div class="newthebtn afghitpo">
                <button type="button" class="hrbtns contractbtn addbttn indRadBttn" style="margin-bottom: 7px;" onclick="showMdModal('<?= base_url() ?>/Payroll/Branch/branch_addmodal/0','Add Branch')" style="height: fit-content;padding: 6px 12px;">ADD BRANCH</button>
                <!-- <button type="button" class="approvedbtn finishedbtn addbttn" style="margin-bottom: 7px;" onclick="showMdModal('<?= base_url() ?>/Payroll/Branch/branch_addmodal/0','Add Branch')" style="height: fit-content;padding: 6px 12px;">ADD BRANCH</button> -->
            </div>
        </div>
        <div class="cexpbdymt col-md ab_ef mhj_crcto" id="first_col" style="display: block;margin-right: -10px !important;">
            <div class="container-fluid  bg-white bdrds" style="margin-top: -1px !important;margin-right: -10px;">
                ...
                <div class="card">
                    <div class="card-body">
                        <!-- <div class="row">
                         ...
                         <div class="col-md-6">
                            ...
                            style="margin-bottom: 7px;"onclick="showMdModal('<?= base_url() ?>/Payroll/Branch/branch_addmodal/0','Add Branch')"
                            style="height: fit-content;padding: 6px 12px;">ADD BRANCH</button>
                            </div> 
                            <div class="col-md-6 addpadding">
                                <button type="button" id="toggle_btn" class="contractfilter pull-right row-mtop5" data-bs-toggle="tooltip" title="" data-bs-title="Toggle Table" style="margin-right: 10px; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; padding-right: 10px;">
                                    <i class="fa-solid fa-angles-left"></i>
                                </button>
                            </div>
                            <div class="col-md-6 addpadding mryt">
                                <button type="button" id="toggle_btn" class="contractfilter edittglbtn6 viewbtnByToggle nwcl" data-bs-toggle="tooltip" title="" data-bs-title="Toggle Table" style="margin-right: 10px; padding-top: 5px; padding-bottom: 5px; padding-left: 10px; padding-right: 10px;">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-2 datepicker1 drppp-1" style="margin-top: 15px;">
                            ...
                            <div class="col-md-4 qarow mrgntp01">
                                <div class="purchasegrp">
                                    <div class="dropdown-with-icon dropdownalignment drppp-1" style="border-radius:4px 0px 0px 4px;">
                    ...
                    <div class="row">
                        <!--<div class="col-md-12">-->
                        <div class="demo-html">
                            <table id="example" class="display dataTable table-responsive display responsive" style="width: 100%; " aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>

                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="Name: activate to sort column descending" style="font-weight:normal ;">Branch Code</th>

                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">Branch Name</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="font-weight:normal ;">Location</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">Head branch</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;"> Type</th>

                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">Status</th>
                                    </tr>
    ...
    <div class="col-md-8 exptblecol mt-2 ab_hij" id="sec_col" style="display: none;margin-top: -1px !important;">
        <div class="container-fluid  tblcontainer p-2">
                            ...
                            <div class="tabs d-flex newtabml ml-1">
                                ...
                                <!-- <div>
                                        <button class="tablinks" style="width:140px"
                                            onclick="openTab(event, 'proposals')"> Employees</button>
                                    </div>
                                    <div>
            ...
            <div id="carouselExampleIndicators" class="carousel slidemt" data-bs-interval="false">
                <div class="carousel-inner scroll-images">
                    ...
                    <div class="carousel-item" style="text-align: center;">
                        <div class="container">
                            <div class="child mb-0" style="height:auto;">
                                <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'deal')">Payslips</button>
                            </div>
                        </div>
                    </div>
                    <div class="carousel-item" style="text-align: center;">
            ...
            <div id="deal" class="tabcontent  mtgb" style="margin-left: 10px; margin-right: 10px;">
                <div class="row">
                    <div class="demo-html" style="overflow-x: auto;">
                        <table id="example3" class="display dataTable display responsive nowrap " style="width: 100%; " aria-describedby="example_info">
                            <thead class="theadrow hdrw">
                                <tr>

                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="Name: activate to sort column descending" style="font-weight:normal ;">Employee Name</th>
                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="font-weight:normal ;">Employee ID</th>
                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                        Pay month</th>
                                    <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                        Pay Date</th>
            ...
            <div id="task" class="tabcontent  mtgb" style="margin-left: 10px; margin-right: 10px;">
                <div class="row">
                    <div class="demo-html" style="overflow-x: auto;">
                        <table id="example2" class="display dataTable display responsive " style="width: 100%; " aria-describedby="example_info">
                            <thead class="theadrow hdrw">
                                <tr>
                ...
                <div class="row">
                    <div class="demo-html" style="overflow-x: auto;">
                        <div class="table-responsive">
                            <table id="example8" class="display dataTable display responsive nowrap tblalign " style="width: 100%;" aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="demo-html mt-0" style="overflow-x: auto;">
                        <table id="example10" class="display dataTable display responsive nowrap tblalign" style="width: 100%;" aria-describedby="example_info">
                            <thead class="theadrow hdrw">
                                <tr>
    ...
    <script type="text/javascript">
        function deductionTable() {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Payroll/Branch/branchTable',
                dataType: 'json',
    ...
    <script>
        function updateBranchStatus(id) {
            ...
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Payroll/Branch/updateBranchStatus/' + id,
                data: {
                    status: status
                },
                dataType: 'json',
    ...
    <script>
        ...
        function fetchBranch(id) {
            $.ajax({
                type: 'post',
                url: '<?= base_url() ?>/Payroll/Branch/fetchBranch/' + id,
                dataType: 'json',
                success: function(result) {
