...
<div class="newthebtn afghitpo">
     <button type="button" class="approvedbtn finishedbtn addbttn  "
                                    ...
                                    onclick="showModal(`<?= base_url('Payroll/Earnings/EarningsAddModal') ?>`,`Add Earning`)"
                                    style="height: fit-content;padding: 6px 12px;">ADD EARNING</button>
</div> 
  
<!-- <button type="button" class="approvedbtn finishedbtn addbttn indRadBttn "
                                    style="margin-bottom: 7px;"
                                    onclick="showModal(`<?= base_url('Payroll/Earnings/EarningsAddModal') ?>`,`Add Earning`)"
                                    style="height: fit-content;padding: 6px 12px;">ADD EARNING</button>
</div> -->
        ...
        <div class="cexpbdymt col-md ab_ef mhj_crcto" id="first_col" style="display: block;margin-right: -10px !important;">
             <div class="container-fluid  bg-white rad_bo" style="margin-top: -1px !important;margin-right: -10px;">
                    ...
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-6 addpadding">
                                ...
                                <button type="button" id="toggle_bbtn" class="contractfilter pull-right row-mtop5 "
                                ...
                                <!-- <button type="button" onclick="togg(1)"
                            class="contractfilter edittglbtn5 edittglbtn6 viewbtnByToggle to-al" data-bs-toggle="tooltip"
                            data-bs-title="Toggl Table" data-bs-original-title="" title="" data-bs-trigger="hover">
                                        ...
                                        <table id="example" class="display dataTable display responsive"
                                            ...
                                            <thead class="theadrow hdrw">
                                                <tr>
                                                    <th class="sorting sorting_asc" tabindex="0" aria-controls="example"
                                                        ...
                                                        style="font-weight:normal ;">Earning Name</th>
                                            ...
                                            <tbody id="Earningsappend">
                                                ...
                                                <!-- <tr class="odd">
                                                    <td>EN_01
                                                        ...
                                                        <p class="header-effect">
                                                            ...
                                                            <a onclick="showModal('Edit.html','Edit Earnings')"
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><span class="undelsp draftsp">Tom</span></td>
                                                    <td>
                                                        <label class="switchslider"> <input type="checkbox"
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><span class="undelsp draftsp">ben</span></td>
                                                    <td>
                                                        <label class="switchslider"> <input type="checkbox"
                                                                checked><span class="slider round"></span></label>
                                                    </td>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><span class="undelsp draftsp">Max</span></td>
                                                    <td>
                                                        <label class="switchslider"> <input type="checkbox"
                                                                checked><span class="slider round"></span></label>
                                                    </td>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><span class="undelsp draftsp">Jack</span></td>
                                                    <td>
                                                        <label class="switchslider"> <input type="checkbox"
                                                                checked><span class="slider round"></span></label>
                                                    </td>
                                                ...
                                                <tr class="odd">
                                                    ...
                                                    <td></td>
                                                    <td></td>
                                                    <td><span class="undelsp draftsp">Joe</span></td>
                                                    <td>
                                                        <label class="switchslider"> <input type="checkbox"
                                                                checked><span class="slider round"></span></label>
                                                    </td>
        ...
        <div class="col-md-8 exptblecol mt-2 ab_hij" id="sec_col"
            ...
            <div class="container-fluid  tblcontainer p-2">
                <hr class="fileline" />
                <div class="row vendcarmt mt-0" style="padding-left: 20px !important;margin-top: 8px !important;">
                    <div class="col-md-12 ">
                        <div class="desktop">
                                ...
                                <thead class="theadrow hdrw">
                                    <tr>
                                        ...
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1"
                                            ...
                                            aria-label="Name: activate to sort column descending"
                                            style="font-weight:normal ;">Employee ID
                                        </th>
    ...
    <script>
        $(document).ready(function ()
        {
            $(document).on('click', '.earningsstatus-toggle', function ()
            {
                ...
                $.ajax({
                    type: 'POST',
                    url: '<?= base_url() ?>/Payroll/Earnings/updateEarningsStatus',
    ...
    <script>
        function fetch_earnings()
        {
            ...
            table.destroy();
            console.log('earnings function called');
            $.ajax({
                type: 'GET',
                url: '<?= base_url() ?>/Payroll/Earnings/fetch_earnings',
                dataType: 'json',
                success: function (result)
                {
                    $('#Earningsappend').html(result);
                    getResponse();
                },
                error: function (xhr, status, error)
                {
        ...
        fetch_earnings();
        function taggleEarnins(id)
        {
            fetchearningsdetails(id);
            var hidden_columns = [3, 4, 5, 6];
    ...
    <script>
        function fetchearningsdetails(id)
        {
            console.log('dedtypedetails function called');
            $.ajax({
                type: 'post',
                url: '<?= base_url() ?>/Payroll/Earnings/fetchearningsdetails/' + id,
                // data:{id:id},
                dataType: 'json',
                success: function (result)
                {
...
<script>
        $(document).ready(function () {
            $(document).on('click', '.dropdown-item.expense', function () {
                $(this).toggleClass('active');
                getExpense();
            });
            $(document).on('click', '.dropdown-item.task', function () {
                $(this).toggleClass('active');
                ids = $('#input_id').val();
                getTask(ids);
            });
        ...
        <script>
        function togg(a) {
            var hidden_columns = [4, 5, 7, 8];
            var _visible = true;
            if ($("#first_col").hasClass("col-md-12")) {
                $("#first_col").removeClass("col-md-12").addClass("col-md-5");
                $("#first_col").addClass("pe-0");
                $("#first_col div.dt-buttons").css('margin-bottom','20px');
                ...
                $("#first_col div.dt-buttons").css('margin-bottom','0px');
                $("#first_col").removeClass("pe-0");
                $("#sec_col").hide();
                $("#toggle_btn")
                    .find("i")
                    .removeClass("fa fa-angle-double-right")
        ...
        $("#expandbtn").click(function () {
            if ($("#sec_col").hasClass("col-md-7")) {
                ...
                $("#sec_col").css('padding-right', '16px ');
                $("#sec_col").css('padding-left', '46px ');
                $("#first_col").hide();
            } else {
                $("#sec_col").removeClass("col-md-12").addClass("col-md-7");
                $("#sec_col").css('padding-right', '36px  ');
                $("#sec_col").css('padding-left', '0px ');
                $("#first_col").show();
            }
        });
        // view toggle for show contract
        function viewButton(id) {
            var hidden_columns = [3, 4, 6, 7];
            var _visible = false;
            if ($("#first_col").hasClass("col-md-12")) {
                $("#first_col").removeClass("col-md-12").addClass("col-md-5");
                $("#first_col").addClass("pe-0");
        ...
        function getViewDatas(id) {
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Expenses/getViewDatas/' + id,
                dataType: 'json',
                success: function (result) {
                    $('#view_header').html(result.name);
                    $('#view_amount').html(result.amount);
                    $('#view_date').html(result.expense_date);
                    if (result.invoice_id != '') {
                        $('#view_invoice').html('<button type="button" class="inv-btn hrbtns">' + result.invoice_id + '</button>');
                    }
                    if (result.file != '') {
                        $('.file-block .file-name').text(result.file);
                        $('.file-block, #exp-receipt').show();
                    } else {
                        $('.file-block, #exp-receipt').hide();
                    }
                    $('#delete_view').attr("onclick", "deleteExpense(" + result.id + ",'1')");
                    $('#view_copy').attr("onclick", "window.location.href = '<?= base_url() ?>/expenses/copy/" + result.id + "'");
                    $('#view_edit').attr("onclick", "window.location.href = '<?= base_url() ?>/expenses/edit/" + result.id + "'");
                    $('#view_print').attr("onclick", "window.location.href = '<?= base_url() ?>/expenses/printer/" + result.id + "'");
                    $('#total_view').html('<p><strong>Total with Tax:</strong>' + result.total + '</p>');
                    $('#remainder_view_modal').attr("onclick", "showMdModal('<?= base_url() ?>/expenses/remainder/" + result.id + "','Set Expense Reminder')");
                    $('#task_view_modal').attr("onclick", "showMdModal('<?= base_url() ?>/expenses/addTask/" + result.id + "','New Task')");
                    getRemainder(result.id);
                    getTask(result.id);
                    $('#input_id').val(result.id);
                }
            });
        }
        function deleteRemainder(id) {
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Expenses/deleteRemainder/' + id,
                dataType: 'json',
                success: function (result) {
                    getRemainder(result);
                }
        ...
        function deleteTask(id) {
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Expenses/deleteTask/' + id,
                dataType: 'json',
                success: function (result) {
                    getTask(result);
                }
        ...
        function changeStatus(id, val) {
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Expenses/changeStatus/' + id + '/' + val,
                dataType: 'json',
                success: function (result) {
                    getTask(result);
                }
        ...
        function changePri(id, val) {
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Expenses/changePri/' + id + '/' + val,
                dataType: 'json',
                success: function (result) {
                    getTask(result);
                }
        ...
        function getTask(id) {
            clas = document.querySelectorAll('.task.dropdown-item.active');
            len = clas.length;
            i = 0;
            attr = {};
            while (i < len) {
                column = clas[i].getAttribute("column");
                val = clas[i].getAttribute("val");
                attr[val] = column;
                i++;
            }
            var final = JSON.stringify(attr);
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Expenses/getTask/' + id,
                data: 'final=' + final,
                dataType: 'json',
                success: function (result) {
                    $('#list_g').html(result.list);
                }
            });
        }
    </script>
