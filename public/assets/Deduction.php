<body id="wrapper" style="margin-top: 10px;">
    <div class="row">
        <div class="content2 productcontainer" id="first_col" style="display: block;margin-right: -10px !important;">
            ...
            <div class="row">
                            <div class="col-md-6">
                                <button type="button" class="approvedbtn finishedbtn addbttn adddeduction "
                                    style=""  onclick="showMdModal('<?=base_url()?>/Payroll/Deductions/deduction_addmodal/0','Add Deduction')"
                                    style="height: fit-content;padding: 6px 12px;"><i class="fa fa-plus"></i> ADD DEDUCTION</button>
                            </div>
                           </div>
                <div class="card">
                    <div class="card-body">
...
function deleteDeduction(id) {
    $.ajax({
        type: 'POST',
        url: '<?= base_url() ?>/Payroll/Deductions/deleteDeduction/' + id,
        dataType: 'json',
        success: function(response) {
