<body id="wrapper">
    <div class="row invtblerow">
            ...
            <div class="container-fluid  tblcontainer p-2">
                <div class="row">
                    <div class="col-md-12 addpadding">
                        <button type="button" class="hrbtns contractbtn addbttn create crm-add-btn newcom"
                            onclick="showMdModal(`<?= base_url('Crm/addcommission') ?>`,`Add`); "><i class="fa fa-plus" aria-hidden="true"></i> NEW COMMISSION
                        </button>
                        <button type="button" id="toggle_btn" onclick="togglecomView(id)"
                            class="contractfilter edittglbtn5 edittglbtn6 viewbtnByToggle pull-right togglecom" data-bs-toggle="tooltip" title="Toggle Table"
                ...
                <div class="card">
                    <div class="card-body">
                      ...
                      <div class="purchasegrp">
                        <div class="dropdown-with-icon dropdownalignment  dropcom" style="border-radius:4px 0px 0px 4px;">
                                        ...
                                        <thead class="theadrow hdrw">
                                            <tr>
                                                <th class="select-checkbox sorting_disabled" rowspan="1" colspan="1"
                                                    ...
                                                    <input type="checkbox" id="all_check" class="select-checkbox" onchange="checkAll()">
                                                </th>
                                                <th>S.No</th>
                                                <th>Title</th>
                                                <th>Requested By</th>
        ...
        <div class="col-md-8 sec-column exptblecol ps-0" id="sec_col" style="display:none;">
            <div class="container-fluid  tblcontainer p-2">
                <hr class="fileline" />
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="hrbtns contractbtn addbttn pull-right camp"
                                onclick="showMdModal('add.html','ADD COMISSION');">ADD COMISSION
                            </button>
                        </div>
                    </div>
                    <div class="row">
...
<span class="Bcgbttm capsule"></span>
    ...
    <script>
    function getcommissionUsers() {
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>/Crm/getcommissionUsers',
            dataType: 'json',
    ...
    function togglecomView(id) {
        $.ajax({
            type: 'POST',
            url: '<?= base_url() ?>/Crm/getcomtabUsers/' + id,
            dataType: 'json',
            success: function(result) {
                $('#stripedcommissiontab').html(result);
            }
        });
