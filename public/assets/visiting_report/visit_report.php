<body id="wrapper">
    <div class="row">
        <div class="expbdymt" id="first_col">
                        ...
                        <div class="row">
                            <div class="col-md-12 addpadding">
                                <div class="crm-add-btn">
                                    <button type="button" class="hrbtns contractbtn addbttn " onclick="showModal(`<?= base_url('Crm/addvisit') ?>`,`Add`)" style="margin-top: 0px !important;"> <i class="fa fa-plus" aria-hidden="true"></i> ADD
                                    </button>
                                    <button type="button" class="hrbtns record-button contractbtn addbttn" onclick="window.location.href='<?= base_url('Crm/visitexpense') ?>'"><i class="fa fa-plus" aria-hidden="true"></i>
                                        VISIT EXPENSE
                                    </button>
                                </div>
                                <!-- <button type="button" id="toggle_btn" onclick="toggleViews(id)" class="contractfilter edittglbtn5 edittglbtn6 viewbtnByToggle pull-right" data-bs-toggle="tooltip" title="" data-bs-title="Toggle Table">
                                    <i class="fa fa-angle-double-left"></i>
                                </button> -->

                            </div>
                        </div>
                        <!-- <h4 class="h4">Visiting report</h4> -->
                        <!-- <hr class="fileline"> -->
                        ...
                        <div class="row">
                            <!-- <div class="col-md-2 datepicker1">
                                <div class="purchasegrp">
                                    <label for="unitname" class="purchaseinfo assetsmargin1">Date</label>
                            ...
                            <div class="col-md-4">
                                <div class="purchasegrp">
                                    <label for="unitname" class="purchaseinfo assetsmargin1" style="margin-bottom: 6px;">Assets</label>
                                    <div class=" dropdown-with-icon dropdownalignment">
                                        <select class="selectpicker multiselect" data-name="name" multiple data-actions-box="true" data-live-search="true" title="None selected">
                                            <option value="4">Apple MacBook Pro 13 inch 256GB MPXU2</option>
                                            <option value="13">SR00012 apple amcbook pro 13 inch</option>
                                            <option value="14">SF001 surface pro 7</option>
                                            <option value="5">ip 123ssa iphone 7</option>
                                            <option value="8">mo asfgg</option>
                                            <option value="6">SAT ASG34783849</option>
                                            <option value="9">hhh phone</option>
                                            <option value="6">1234 bas system</option>
                                            <option value="6">acer laptop</option>
                                        </select>
                                    </div>
                                </div>
                            </div>
                ...
                <div class="card">
                    <div class="card-body" style="padding-left: 34px;">
                        <div class="row">
                            <div class="row">
                                <div class="demo-html">
                                    <table id="example" class="display dataTable display responsive nowrap " style="width: 100%; " aria-describedby="example_info">
        ...
        <div class="col-md-8 sec-column exptblecol ps-0" id="sec_col">
            <div class="container-fluid  tblcontainer p-2">
                        ...
                        <div class="desktop">
                            ...
                            <div class="scroll-images custml toptea border-bott ">
                                ...
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'proposals')">Teams</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'deal')">Deals</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'task')">Tasks</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'reimbur')">Reimbursement</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'target')">Targets</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'payment')">Payments</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'user')">Users</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'remainder')">Remainder</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'expense')">Expense</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'file')">Files</button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button class="tablinks tb-links childd-tabb-links" onclick="openTab(event, 'activity')">Activity </button>
                                </div>
                                <div class="child mb-0 childd-tabb">
                                    <button id="expandbtn" class="tablinks tb-links expand-button childd-tabb-links" data-toggle="tooltip" data-bs-title="Toggle full view" data-bs-custom-class="custom-tooltip" data-bs-trigger="hover"><i class="fa fa-expand"></i></button>
                                </div>
                ...
                <div id="carouselExampleIndicators" class="carousel slidemt" data-bs-interval="false">
                    <div class="carousel-inner scroll-images">
                        ...
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'proposals')">Teams</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'deal')">Deals</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                        ...
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'reimbur')">Reimbrishment</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'target')">Targets</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'payment')">Payments</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'user')">Users</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                        ...
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'expense')">Expense</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                            <div class="container">
                                <div class="child mb-0" style="height:auto;">
                                    <button class="tablinks tabresact" style="width:70%" onclick="openTab(event, 'file')">Files</button>
                                </div>
                            </div>
                        </div>
                        <div class="carousel-item" style="text-align: center;">
                ...
                <div id="profile" class="tabcontent  mtgb prev">
                        ...
                        <div class="analytics_dashboard_upper">
                            <div class="analytics_dashboard_upper_right">
                                <div class="col-md-2 datepicker1 Date">
                                    <div class="purchasegrp">
                                        <input type="text" id="reportrange" name="dates" class="form-control purchaseselects statbtn doubledate" style="height: 20px !important;text-align: center;" placeholder="Date">
                                    </div>
                                </div>
                                <iframe src="https://www.google.com/maps/embed?pb=!1m14!1m12!1m3!1d4012924.12383846!2d78.28976490000001!3d10.821166349999999!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!5e0!3m2!1sen!2sin!4v1705486498535!5m2!1sen!2sin" width="100%" height="100%" style="border:0;margin-top: 20px;" allowfullscreen="" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
                            </div>
                    ...
                    <div class="row">
                        <div class="col-md-12"><br>
                            ...
                            <img src="https://perfexmodules.gtssolution.site/modules/warehouse/uploads/approval/approved.png" class="img-width-height">
                        </div>
                    </div>
                </div>
                <div id="proposals" class="tabcontent  mtgb">
                    <div class="row">
                        ...
                        <div class="col-md-3">
                            <button type="button" class="hrbtns contractbtn addbttn pull-right camp" onclick="showModal('add.html','ADD VISITING REPORT');">ADD VISITING REPORT
                            </button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="demo-html" style="overflow-x: auto;">
                            <table id="example1" class="display dataTable display responsive nowrap " style="width: 100%; " aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="Name: activate to sort column descending" style="font-weight:normal ;">Team Name</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="font-weight:normal ;">Leaders</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                            Staff</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                            Zone</th>
                    ...
                    <div class="row">
                        <div class="demo-html" style="overflow-x: auto;">
                            <table id="example1" class="display dataTable display responsive nowrap " style="width: 100%; " aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="Name: activate to sort column descending" style="font-weight:normal ;">Company</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="font-weight:normal ;">Phone</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="font-weight:normal ;">Value</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                            Assigned</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                            Tags</th>
                                ...
                                <tbody>
                                    <tr class="odd">
                                        ...
                                        <td></td>
                                        <td></td>
                                        <td><span class="undelsp draftsp">Type</span> <span class="undelsp draftsp">Status</span></td>>
                                        <td>may</td>
                                    </tr>
                                    <tr class="odd">
                                        <td>qsr</td>
                ...
                <div id="task" class="tabcontent  mtgb">
                    ...
                    <div class="row">
                        <div class="demo-html" style="overflow-x: auto;">
                            <table id="example1" class="display dataTable display responsive " style="width: 100%; " aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>
                                ...
                                <tbody>
                                    <tr class="odd">
                                        <td class="invtble"><a href="#" class="" onclick="showModal('../vtestmodal.html','jaya')">253</a>
                                        </td>
                                        <td class="progtble2">
                                            <a href="#" class="" onclick="showModal('../vtestmodal.html','jaya')">jaya</a>

                                            <p class="header-effect">
                                                <a><span class=" text-success">Start
                                                        Timer</span></a>
                                                <span class="black">|</span> <a href="#" onclick="showModal('../edittaskmodal.html','Edit')"><span class="">
                                        ...
                                        <td><button type="button" id="stbutton2" style="border: none;" class=" status-button  dropdown-toggle range-toggle" data-bs-toggle="dropdown">Low
                                            </button>
                                            <ul class="dropdown-menu">
                ...
                <div id="reimbur" class="tabcontent  mtgb">
                    ...
                    <div class="row">
                        <div class="demo-html">
                            <table class="example1 display dataTable display responsive nowrap " style="width: 100%; " aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>
                                        <th>Staff</th>
                    ...
                    <div class="row">
                        <div class="demo-html" style="overflow-x: auto;">
                            <table id="example1" class="display dataTable display responsive nowrap " style="width: 100%; " aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="Name: activate to sort column descending" style="font-weight:normal ;">Target name</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="font-weight:normal ;">Leaders</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                            Staff</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                    ...
                    <div class="row">
                        <div class="demo-html" style="overflow-x: auto;">
                            <div class="table-responsive">
                                <table class="example1 display dataTable display responsive nowrap tblalign " style="width: 100%;" aria-describedby="example_info">
                                    <thead class="theadrow hdrw">
                                        <tr>
                                            <th>Description</th>
                                            <th>Date</th>
                ...
                <div id="file" class="tabcontent  mtgb">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="demo-html mt-0" style="overflow-x: auto;">
                                <table id="example1" class="display dataTable display responsive nowrap tblalign" style="width: 100%;" aria-describedby="example_info">
                                    <thead class="theadrow hdrw">
                                        <tr>
                                            <th class="select-checkbox sorting_disabled">
                                                Filename
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td></td>
                                            <td>
                                                <button type="button" class="closexbtn clsheight" onclick="showModal('edit-job.html','Edit Position')" style="background-color: #03A9F4;" data-bs-toggle="tooltip" data-bs-title="Mail"><i class="fa fa-envelope"></i></button>
                                                <button class="closexbtn clsheight" data-bs-toggle="tooltip" data-bs-title="Remove"><i class="fa fa-remove"></i></button>
                                            </td>
                                        </tr>
                                    </tbody>
                                </table>
                ...
                <div id="expense" class="tabcontent  mtgb">
                    <div class="row">
                        <div class="col-md-9"></div>
                        <div class="col-md-3">
                            <button type="button" class="hrbtns contractbtn addbttn pull-right camp" onclick="showModal('add.html','Add Campaign');">ADD CAMPAIGN
                            </button>
                        </div>
                    </div>
                    <div class="row">
                        <div class="demo-html" style="overflow-x: auto;">
                            <table id="example1" class="display dataTable display responsive  " style="width: 100%; " aria-describedby="example_info">
                                <thead class="theadrow hdrw">
                                    <tr>
                                        <th class="sorting sorting_asc" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-sort="descending" aria-label="Name: activate to sort column descending" style="font-weight:normal ;">#</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Position: activate to sort column ascending" style="font-weight:normal ;">category</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                            Name</th>
                                        <th class="sorting" tabindex="0" aria-controls="example" rowspan="1" colspan="1" aria-label="Office: activate to sort column ascending" style="font-weight:normal ;">
                                            Amount</th>
        ...
        <div class="modal-dialog modal-lg">
            ...
            <div class="modal-content">
                <div class="modal-header hdrbg">
                    ...
                    <h5 id="myModalLabel" class="fnt_head">
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $("#toggle_btn").click(function() {
                ...
                if (_visible) {
                    $("#first_col").removeClass("col-md-12").addClass("col-md-4 pe-0");
                    ...
                    $("#first_col").removeClass("col-md-4 pe-0").addClass("col-md-12");
    ...
    <script>
        ...
        function singleCheck(id) {
            ...
            boxes = document.getElementsByClassName("select-checkbox");
            if (checkbox.checked == true) {
                $('.bulk_send').show(1000);
            } else {
                count = 0;
    ...
    <script>
        function savevisitUsers() {
            $.ajax({
                type: 'POST',
                url: '<?= base_url() ?>/Crm/savevisitUsers',
                dataType: 'json',
                success: function(result) {
                    $('#example').DataTable().destroy();
                    $('#visitingreport').html(result);
                    initvisitTable();
                }
            });
